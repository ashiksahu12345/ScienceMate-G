...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "templates",   # Custom global templates folder
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "static",       # Local static folder (for development mode)
]

STATIC_ROOT = BASE_DIR / "staticfiles"   # Where collectstatic stores files in production
